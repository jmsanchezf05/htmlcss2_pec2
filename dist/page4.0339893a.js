...
var reservasClass = /*#__PURE__*/ function() {
    "use strict";
    function reservasClass(_nombre, _apellidos, _butaca) {
    ...
    _helpers.createClass(reservasClass, [
        {
            key: "setButaca",
            value: function setButaca(numero) {
                this.butaca = numero;
            }
        },
        {
...
var salvaDatos = function(evento) {
    if (validaNombre() && validaApellidos() && validaAsiento) {
        ...
        var reserva = new reservasClass(inputNombre.value, inputApellidos.value, asiento);
